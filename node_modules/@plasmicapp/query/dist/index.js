...
function reactCurrentDispatcher() {
  ...
  if (REACT_MAJOR_VERSION <= 18) {
    return (_b = (_a = r["__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED"]) == null ? void 0 : _a.ReactCurrentDispatcher) == null ? void 0 : _b.current;
  } else {
...
function isPlasmicPrepass() {
  var _a, _b;
  return (_b = (_a = reactCurrentDispatcher()) == null ? void 0 : _a.isPlasmicPrepass) != null ? _b : false;
}
