...
function PageParamsProvider(_a) {
    var children = _a.children, route = _a.route, _b = _a.params, params = _b === void 0 ? {} : _b, _c = _a.query, query = _c === void 0 ? {} : _c;
...
var setRepeatedElementFn = (_c = (_b = (_a$1 = root$1 === null || root$1 === void 0 ? void 0 : root$1.__Sub) === null || _a$1 === void 0 ? void 0 : _a$1.hostUtils) === null || _b === void 0 ? void 0 : _b.setRepeatedElementFn) !== null && _c !== void 0 ? _c : function (fn) {
...
var hostVersion = "2.0.3";

var _a;
var root = globalThis;
if (root.__Sub == null) {
    root.__Sub = __assign({ React: React, ReactDOM: ReactDOM, ReactDOMClient: ReactDOMClient, jsxRuntime: jsxRuntime, jsxDevRuntime: jsxDevRuntime, PlasmicQuery: PlasmicQuery, hostModule: hostModule, hostVersion: hostVersion, hostUtils: {
...
export { DataContext, DataCtxReader, DataProvider, GlobalActionsContext, GlobalActionsProvider, PageParamsProvider, PlasmicCanvasContext, PlasmicCanvasHost, PlasmicLinkProvider, PlasmicTranslatorContext, applySelector, mkMetaName, mkMetaValue, registerComponent, registerFunction, registerGlobalContext, registerToken, registerTrait, repeatedElement, stateHelpersKeys, useDataEnv, useGlobalActions, usePlasmicCanvasComponentInfo, usePlasmicCanvasContext, usePlasmicLink, usePlasmicLinkMaybe, usePlasmicTranslator, useSelector, useSelectors };
